...
static const CGFloat kMaxPaddingBetweenFloatingLabelAndEditingText = 12.0f;
static const CGFloat kMinPaddingBelowAssistiveLabels = 3.0f;
static const CGFloat kMaxPaddingBelowAssistiveLabels = 6.0f;
